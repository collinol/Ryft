...
{
    /// <summary>
    /// Deals damage and heals the user for a portion of damage dealt.
    /// </summary>
    public class DrainLifeAbility : AbilityRuntime
    {
        public override void Execute(FightContext ctx, IActor explicitTarget = null)
        {
            ...
            // Heal owner for 50% of damage dealt
            int healAmount = Mathf.Max(1, finalDmg / 2);
            Owner.Heal(healAmount);

            ctx.Log($"{Owner.DisplayName} drains {finalDmg} life from {target.DisplayName}, healing for {healAmount}!");
