...
{
    /// <summary>
    /// Gust - Deal 5 wind damage and push enemy away.
    /// </summary>
    public class Gust : CardRuntime
    {
        ...
        public override void Execute(FightContext ctx, IActor explicitTarget = null)
        {
            ...
            ctx.Log($"{Owner.DisplayName} casts Gust for {dmg} damage and pushes {target.DisplayName} away!");
        }
    }
}
